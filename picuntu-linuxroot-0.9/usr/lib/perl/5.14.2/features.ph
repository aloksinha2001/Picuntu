...
unless(defined(&_FEATURES_H)) {
    ...
    eval 'sub __GLIBC_MINOR__ () {15;}' unless defined(&__GLIBC_MINOR__);
    ...
    if( &__GNUC_PREREQ (2, 7)  && defined (&__OPTIMIZE__)  && (defined (&_LIBC) || !defined (&__OPTIMIZE_SIZE__))  && !defined (&__NO_INLINE__)  && defined (&__extern_inline)) {
	eval 'sub __USE_EXTERN_INLINES_IN_LIBC () {1;}' unless defined(&__USE_EXTERN_INLINES_IN_LIBC);
    }
